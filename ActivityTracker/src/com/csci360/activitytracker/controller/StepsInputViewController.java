...
public class StepsInputViewController implements Initializable  {
	...
	public Button ok=new Button();
	  ...
	  @FXML public Spinner<Integer> steps;
	...
	public void setSpinner() {
		 SpinnerValueFactory<Integer> stepsClick =  new
		 SpinnerValueFactory.IntegerSpinnerValueFactory(1, 12, 1, 2);
		 this.steps.setValueFactory(stepsClick);
	}
